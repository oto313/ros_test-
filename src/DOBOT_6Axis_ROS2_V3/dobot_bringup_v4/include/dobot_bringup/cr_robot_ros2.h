...
using GripperCommand = control_msgs::action::GripperCommand;
  using GoalHandleGripperCommand = rclcpp_action::ServerGoalHandle<GripperCommand>;
    rclcpp_action::GoalResponse gripper_handle_goal(const rclcpp_action::GoalUUID & uuid, std::shared_ptr<const GripperCommand::Goal> goal);
    rclcpp_action::CancelResponse gripper_handle_cancel(const std::shared_ptr<GoalHandleGripperCommand> goal_handle);
    void gripper_handle_accepted(const std::shared_ptr<GoalHandleGripperCommand> goal_handle);
  void gripper_execute(const std::shared_ptr<GoalHandleGripperCommand> goal_handle);
